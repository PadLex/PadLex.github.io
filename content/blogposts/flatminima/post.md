...
## Let's Test It
@keskar2017large's formulation of the Flat Minima Hypothesis predicts that ***{c3}(sharpness should correlate with the model's generalization gap)*** — the difference between training and validation accuracy.
...
Well shoot. Each optimizer seems to be biased toward converging to regions of different sharpness, but sharpness seems to be completely uncorrelated with generalization.
...
## Questioning the field's assumptions
